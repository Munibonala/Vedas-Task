...
export class UpdateUserComponent implements OnChanges, OnInit {
 ...
 // public loading = false;
  ...
  /*ngOnInit(){
    this.paramsSub = this.activeRoute.paramMap.subscribe(params => {
      this.userID = +params.get['userID'];
     // this.loading = true;
      this.roleService.readRoles()
      .subscribe(roles => {this.user = roles['records'], this.loading = false; }, error => {
        this.loading =false;
      });
